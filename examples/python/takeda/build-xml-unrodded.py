...
void_cell = openmc.Cell(cell_id=2, name='cell 2')
...
void_cell.region = +fuel_x_max & -void_x_max & +core_y_min & -void_y_max & +core_z_min & -core_z_max
refl_cell.region = ~fuel_cell.region & ~void_cell.region & +core_x_min & +core_y_min & +core_z_min & -core_x_max & -core_y_max & -core_z_max
...
root.add_cells([fuel_cell, void_cell, refl_cell])
