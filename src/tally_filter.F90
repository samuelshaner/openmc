...
!===============================================================================
  ...
  contains
    procedure :: get_all_bins => get_all_bins_particle
...
!===============================================================================
  subroutine get_all_bins_particle(this, p, estimator, match)
    ...
    call match % bins % push_back(next_bin)
    call match % weights % push_back(weight)

  end subroutine get_all_bins_particle
